...
case "$MODE" in
  clipboard)
    # SECURITY: Use in-memory tmpfs for clipboard contents to prevent persistent leakage
    ...
    # SECURITY: Ensure temporary file is securely deleted after async operation completes
