...
case "$MODE" in
  clipboard)
    # SECURITY: Use XDG_RUNTIME_DIR for tmpfs to avoid writing sensitive clipboard data to disk
    ...
    # SECURITY: Ensure file is deleted after the asynchronous send completes
