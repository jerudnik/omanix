...
case "$MODE" in
  clipboard)
    # SECURITY: Use XDG_RUNTIME_DIR (tmpfs) to avoid writing sensitive clipboard data to disk
    ...
    # SECURITY: Clean up the temporary file after asynchronous localsend finishes
