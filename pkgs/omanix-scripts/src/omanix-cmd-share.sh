...
case "$MODE" in
  clipboard)
    # SECURITY: Use XDG_RUNTIME_DIR for tmpfs to avoid writing sensitive clipboard data to persistent disk
    ...
    # SECURITY: Clean up the sensitive file after the async systemd-run command completes
