...
case "$MODE" in
  clipboard)
    # SECURITY: Use XDG_RUNTIME_DIR (tmpfs) to avoid persisting sensitive clipboard data to disk
    ...
    # SECURITY: Wrap in shell to ensure sensitive temporary file is deleted after asynchronous send
